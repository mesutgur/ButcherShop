...
namespace ButcherShop.WebUI
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            // E-posta gönderme servisi buraya eklenecek
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            // SMS gönderme servisi buraya eklenecek
            return Task.FromResult(0);
        }
    }

    // ApplicationUserManager sınıfını düzelttik
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<ButcherShopContext>()));

            // Kullanıcı adı doğrulama ayarları
    ...
    // ApplicationSignInManager sınıfını düzelttik
